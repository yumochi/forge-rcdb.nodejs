...
import './Viewing.Extension.MyAwsomeExtension.scss'
...
class MyAwsomeExtension extends MultiModelExtensionBase {
  ...
  static get ExtensionId() {
    ...
    return 'Viewing.Extension.MyAwsomeExtension'
  }
  ...
  load () {
    ...
    console.log('Viewing.Extension.MyAwsomeExtension loaded')
  ...
  unload () {
    ...
    console.log('Viewing.Extension.MyAwsomeExtension unloaded')
